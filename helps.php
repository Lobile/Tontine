...
$result4 = $mysqli->query("SELECT  member_id, avalist_name, firstname,lastname,phone,gender,mstatus,address, cast(Today as date) as Today FROM member") or die(mysqli_error($mysqli));
$result = $mysqli->query("SELECT savings_id, savings_interest , (amount+amount * 10/100) as loans, cast(gone as date) as Today, sname, sEmail,saving_amount,withdrawed_savings, ceiling((saving_amount) - (amount+amount * 10/100)) as Restwith,ceiling((saving_amount+saving_amount)- withdrawed_savings - (amount+amount * 10/100))  as Rest, Ceiling(saving_amount+saving_amount * savings_interest) as interest FROM savings left join withdraw on withdraw.withdraw_name=savings.sname left join borrows on borrows.bname=savings.sname  left join avance on borrows.bname=avance.avance_name ") or die(mysqli_error($mysqli));
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <center><a href="#" onclick="popup()"><button class="btn btn-primary" id="delete">Add savings</button></a></center>
...
<div id="box7">
<center>
<button class="close-button"  onclick=blob()>Close Menu</button>
            ...
            <form action="pabs.php" method="post" enctype="multipart/form-data">
                       <div class="wrapper">
                        ...
                        <div class="inputBox">
                            <input type="submit" name="funds" value="Refund" required>
...
<div id="box5">
<center>
<button class="close-button"  onclick=popup()>Close Menu</button>
            <div class="contactForm">
                    <form action="epargne.php" method="post" enctype="multipart/form-data">
                       <div class="wrapper">
                        <h2>Savings</h2>
                        </div>
                        ...
                        <div class="inputBox">
                            <input type="submit" name="done" value="Add savings" required>
