...
$result56 = $mysqli->query("SELECT (sum(contribution_amount)* 20/100) +sum(saving_amount)-sum(amount) as cash from borrows right join savings on savings.savings_id=borrows.id  right join contribution on contribution_id=id") or die(mysqli_error($mysqli));
    ...
    <div class="page-inner">
        ...
        <?php while ($row = $result32->fetch_assoc()) : ?>
            <div id="main-wrapper">
                ...
                <a href="contributionSEC.php?page=details2000">
                <?php
                ...
                <a href="savingsSEC.php">
                    <?php 
                     $result6 = $mysqli->query("SELECT sum(helps_amount) as helps FROM helps inner join beneficiary on DOT=beneficiary where hname='".$pabs."'") or die(mysqli_error($mysqli));
                ...
                <div>
                    <div class="row">
                        <a href="borrowsSEC.php">
                            <?php 
                             $result8 = $mysqli->query("SELECT sum(amount) as pay , sum(refunded_amount) as damn,  sum(amount * 10/100) as amountpay FROM borrows left join avance on borrows.bname=avance.avance_name inner join beneficiary on beneficiary.beneficiary = borrows.DOP where bname='".$pabs."'") or die(mysqli_error($mysqli));
                            ...
                            <a>
                                <a href="helpsSEC.php">
                                    <?php
                                     $result7 = $mysqli->query("SELECT sum(saving_amount) as save ,sum(withdrawed_savings) as drains, sum(saving_amount+saving_amount * savings_interest) as suminterest FROM savings left join withdraw on withdraw.withdraw_name=savings.sname inner join beneficiary on beneficiary.beneficiary = savings.gone where sname='".$pabs."'") or die(mysqli_error($mysqli));
                                        ...
                                        <div class="stats-info">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <li>Members<div class="text-success pull-right"><?php while ($row = $result2->fetch_assoc()) : echo $row['total'];
                                                    ...
                                                    <li>Rescues<div class="text-success pull-right"><?php while ($row = $result16->fetch_assoc()) : echo $row['helps'];
                                                                                                    endwhile; ?><<i class="fa fa-level-up"></i></div>
                                                    </li>
