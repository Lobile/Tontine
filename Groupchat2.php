               ...
               $result18 = $mysqli->query("SELECT count(status) as status from member  where status='online'") or die(mysqli_error($mysqli));
                                         ...
                                         echo $row['status']; 
                                                    ...
                                                    Request rescue for an ocassion:
                                                        <form action="Groupchat2.php" method="post">
            Request rescue for an ocassion:
    ...
    <div id="container" style="display: flex;">
        <div id="inner_left_panel">
            ...
            <h3><?php
                ...
                ?></h3>
                <a href="secretary.php" id="frost">Back_to_dashboard</a>
        </div>
        <div id="inner_right_panel">
            <main>
                ...
                <form id="myform" action="Groupchat2.php" method="POST">
...
<main class="page-content content-wrap">
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="logo-box">
                <a href="secr.php" class="logo-text"><span>Ndjangi</span></a>
            </div><!-- Logo Box -->
                        ...
                        <table>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <th>
                                    <form action="screen2.php" method="post" enctype="multipart/form-data">
