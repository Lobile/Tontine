...
<body>
    ...
    $result2 = $mysqli->query("SELECT member_id, contribution_id, lastname, firstname FROM Member inner join Contribution on member_id = contribution_id  where contribution = 2000 ") or die(mysqli_error($mysqli));
    $result = $mysqli->query("SELECT member_id, contribution_id, lastname, firstname FROM Member inner join Contribution on member_id = contribution_id  where contribution = 2000 and activepaid=1 ") or die(mysqli_error($mysqli));
    $result5 = $mysqli->query("SELECT member_id,benefit_id,  lastname, firstname FROM Member inner join beneficiary on member_id = benefit_id where beneficiary=curdate() ") or die(mysqli_error($mysqli));
    ...
    <center>
        <div class="container">
            ...
            <a href="cotisation.php?page=contributefine2000"  id="soa">Fine_Payment</a>
            <div class="row">
                    ...
                    ?>
                     ...
                     <td>  
                                <div class="action">
                                    ...
                                    <a href="upload.php?2000=<?php echo $row['contribution_id']; ?>" class="btn btn-success">paid</a>
                                    <a href="upload.php?Not5=<?php echo $row['contribution_id']; ?>" class="btn btn-danger">Not_paid</a>
    ...
    <?php
                    ...
                    ?>
                                    <a href="upload.php?benefit=<?php echo $row['benefit_id']; ?>" id="soa">benefit</a>
                                    <?php endwhile; ?>
                                    <a href="Recu_2K.php"><button class="btn btn-rounded">Beneficiary_invoice </button></a>
