...
.mapouter{
    ...
    <body class="page-header-fixed">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
            <h3><span class="pull-left"><?php
               if (isset($_SESSION['username'])){
                  echo $_SESSION['username'];
                }
                   ?></span> <a href="javascript:void(0);" class="pull-right" id="closeRight2"><i class="fa fa-angle-right"></i></a></h3>
            <div class="slimscroll chat">
                <div class="chat-item chat-item-left">
                    <div class="chat-image">
                        <img src="admin/<?php
            ...
            <div class="page-sidebar sidebar">
               ...
               if (isset($_SESSION['username'])){
                ...
                <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="icon-book-open"></span>
                    ...
                    <li><a href="contact.php" class="waves-effect waves-button"><span class="icon-book-open"></span>
                        <p>Contact</p>
                    </a></li>
                    </ul>
