...
$result4 = $mysqli->query("SELECT  member_id, avalist_name, firstname,lastname,phone,gender,mstatus,address,Today FROM member") or die(mysqli_error($mysqli));
$result = $mysqli->query("SELECT savings_id, savings_interest , (amount+amount * 10/100) as loans, cast(gone as date) as Today, sname, sEmail,saving_amount,withdrawed_savings, ceiling((saving_amount) - (amount+amount * 10/100)) as Restwith,ceiling((saving_amount+saving_amount * savings_interest)- withdrawed_savings - (amount+amount * 10/100))  as Rest, Ceiling(saving_amount+saving_amount * savings_interest) as interest FROM savings left join withdraw on withdraw.withdraw_name=savings.sname left join borrows on borrows.bname=savings.sname  left join avance on borrows.bname=avance.avance_name ") or die(mysqli_error($mysqli));
$result2 = $mysqli->query("SELECT sum(saving_amount) as save ,sum(withdrawed_savings) as drains, sum(saving_amount-withdrawed_savings) as Youpi, sum(ceiling(saving_amount+saving_amount * savings_interest)) as suminterest FROM savings left join withdraw on withdraw.withdraw_name=savings.sname ") or die(mysqli_error($mysqli));
...
if (isset($_GET['case'])) {
    ...
    if ($id >= $today) {
        ...
        header("location:helpsVICAD.php");
    }
}
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="indexVICAD.php" class="logo-text"><span>Ndjangi</span></a>
                </div><!-- Logo Box -->
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    <li class="active"><a href="indexVICAD.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span>
                            <p>Dashboard</p>
                        </a></li>
                    <li><a href="contributionVICAD.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-bitcoin"></span>
                            <p>Contibution</p>
                        </a></li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-bitcoin"></span><p>Contribution</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="contributionVICAD.php?page=details2000">2000</a></li>
                                <li><a href="contributionVICAD.php?page=details5000">5000</a></li>
                            </ul>
                        </li>
                        ...
                        <ul class="sub-menu">
                            <li><a href="helpsVICAD.php">Savings</a></li>
                            <li><a href="borrowsVICAD.php">Loans</a></li>
                            <li><a href="savingsVICAD.php">Rescues</a></li>
        ...
        <div class="page-inner">
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li><a href="indexVICAD.php">Home</a></li>
            ...
            <div id="main-wrapper">
                <div class="row">
                    ...
                    <!-- <th>withdrawed savings</th> -->
                    <th>Loans</th>
                    <th>Rest_to withdraw</th>
            ...
            while ($row = $result->fetch_assoc()):
                ?>
                                                ...
                                                <td><?php echo $row['saving_amount'] ?></td>
                                                <!-- <td><?php echo $row['savings_interest'] ?></td>
                                                <td><?php echo $row['interest']?> </td> -->
                                                   
                                                <!-- <td><?php echo $row['withdrawed_savings'] ?></td>  -->
                                                <td><?php echo $row['loans'] ?></td>
                                                <td>
                                                <?php echo $row['Restwith'] ?>   
                                                </td> 
                                               
                                                <!-- <td><?php echo $row['Rest'] ?></td>  -->
                                                <!-- <td colspan="4">
                                                    <div class="action">
                                                    <a href="#" onclick="blob()" id="edit">Withdraw</a>
                                                    </div>
                                                </td> -->
                                                </tr>
<?php endwhile;?>
<?php
            while ($row = $result2->fetch_assoc()):
                ?>
                    ...
                    <td></td>
                    <!-- <td><?php echo $row['suminterest']?></td>
                 -->
                    <td><?php echo $row['drains']?></td>
                    <td><?php echo $row['Youpi']?></td>
