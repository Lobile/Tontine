...
$result = $mysqli->query("SELECT id,  ceiling(saving_amount) as savings, cast(DOP as date) as hier,avalist,bname,amount,refunded_amount, ceiling( (saving_amount+saving_amount * savings_interest)-refunded_amount-(amount+amount * 10/100)) as amountsert,  ceiling((amount+amount * 10/100) - (saving_amount)) as amountsend,  amount+amount * 10/100 as amountpay, cast(ADDDATE(DOP, interval 3 month) as date) as dateline FROM borrows left join avance on borrows.bname=avance.avance_name inner join benefiter on benefiter.benefiter_id=borrows.id left join savings on savings.sname=borrows.bname") or die(mysqli_error($mysqli));
$result3 = $mysqli->query(" select sname from savings where saving_amount*2<(select sum(saving_amount) as sumsave from  savings)") or die(mysqli_error($mysqli));
$today=date("Y-m-d");
$result2 = $mysqli->query("SELECT sname FROM savings") or die(mysqli_error($mysqli));
$result5 = $mysqli->query("SELECT  member_id, avalist_name, firstname,lastname,phone,gender,mstatus,Email,address,Today FROM member inner join savings on savings.sname=member.firstname ") or die(mysqli_error($mysqli));
...
$result8 = $mysqli->query("SELECT  member_id, avalist_name, firstname,lastname,phone,gender,mstatus,Email,address,Today FROM member ") or die(mysqli_error($mysqli));
...
if (isset($_GET['case'])) {
    ...
    if ($id >= $today) {
        ...
        header("location:borrowsVICAD.php");
    }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <center><a href="#" onclick="popup()"><button class="btn btn-primary" id="delete">Make Loans</button></a></center>
...
<div id="box7">
<center>
<button class="close-button"  onclick=job()>Close Menu</button>
            <div class="contactForm">
            <form action="avance.php" method="post" enctype="multipart/form-data">
                       <div class="wrapper">
                        <h2>Advancement Borrow</h2>
                        </div>
                        ...
                        <div class="inputBox">
                            <input type="submit" name="refund" value="Refund" required>
                    ...
                    <form action="add2.php" method="post" enctype="multipart/form-data">
                       <div class="wrapper">
                        ...
                        <div class="inputBox">
                            ...
                            <input type="submit" name="add" value="Add borrow" class="btn btn-primary" required>
            ...
            while ($row = $result->fetch_assoc()):
                ?>
                    ...
                    <td colspan="4">
                        ...
                        <a href="#" onclick="job()" id="edit">Refund</a>
                    </td>
                                                </tr>
<?php endwhile;?>
                                            </tbody>
