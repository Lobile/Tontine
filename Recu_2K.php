<?php
   ...
   $pdf->Cell(200,20,"Contribution of 2000 Beneficiary Receipt","0","1","C");
   //table column
   ...
   $pdf->Cell(40,10,"Benefit:","0","1","C");
    ...
    $result=$mysqli->query("select member_id,firstname, lastname, contribution_benefit from member inner join contribution on member_id=contribution_id where contribution_benefit!=0 and contribution_amount=2000") or die($mysqli->error);
   ...
   $pdf->Cell(40,10,"Lastname","1","1","C");
    ...
    $result1=$mysqli->query("select member_id,firstname, lastname from member inner join contribution on member_id=contribution_id where contribution_payment like 'not_paid2%' or contribution_paidfine like 'not_paid2%'") or die($mysqli->error);
