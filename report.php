               ...
               if (isset($_SESSION['username'])){
                  echo $_SESSION['username'];
                   ...
                   ?> <br><small><?php
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-envelope"></span><p>Contribution</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                            <h1>Report Of today</h1>
             <center>
        <form action="enter.php" method="post">

                                    <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Enter Report name" name="login" >
                                    </div>
                                    <div class="form-group">
                                        Enter Date:
                                    ...
                                    <div class="form-group">
                                        Salutations:  <textarea name="message" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                       News:<br>  <textarea name="News" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                   Order of today: <textarea name="order" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                   Projects: <textarea name="project" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                   Goals:<br> <textarea name="obj" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <div class="form-group">
                                   Objectives attained: <textarea name="goals" id="" cols="30" rows="5"></textarea>
                                    </div>
                                    <label>
                                        <input type="checkbox"> Agree the terms and policy
                                    </label>
                                   
                                    <button type="submit" name="paste" class="btn btn-success btn-block m-t-xs">Submit</button>
