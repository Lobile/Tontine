        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    ...
                    <a href="cotisation.php?page=contribute2000">
                        <?php
                        ...
                        <div class="col-lg-8">
                            <div class="col-lg-12 col-md-12">
                                <div class="panel panel-white">
                                    ...
                                    <center><a href="#" onclick="pop()"><button class="btn btn-rounded">Add Member</button></a></center>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td colspan="4">
                                                                <div class="action">
                                                                    <a href="Process.php?delete=<?php echo $row['member_id']; ?>"><i class="fa fa-trash"></i></a> <a href="view.php?view=<?php echo $row['member_id']; ?>"><i class="icon-eye"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endwhile; ?>
                            ...
                            <form action="reset.php" method="POST">
                                <button type="submit" name="reset" class="btn btn-danger" value="reset">Reset</button>
                            </form>
                        </div>
