...
$result3 = $mysqli->query("SELECT  member_id, avalist_name, firstname,lastname,phone,gender,mstatus,address,Today FROM member where activeres=0") or die(mysqli_error($mysqli));
$result4 = $mysqli->query("SELECT  member_id, lastname FROM member where activeres=0") or die(mysqli_error($mysqli));
if (isset($_GET['case'])) {
    $id = $_GET['case'];
    if ($id >= $today) {
       
    }else{
        header("location:savingsVICAD.php");
    }
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="indexVICAF.php" class="logo-text"><span>Ndjangi</span></a>
                    </div><!-- Logo Box -->
                ...
                <div id="main-wrapper">
                    ...
                    <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <center><a href="#" onclick="Bup()"><button class="btn btn-primary" id="delete">Collect Recues</button></a></center>
...
<div id="box4">
<center>
<button class="close-button"  onclick=Bup()>Close Menu</button>
<div class="contactForm">
                    <form action="aide.php" method="post" enctype="multipart/form-data">
                       <div class="wrapper">
                        <h2>Rescues</h2>
                        </div>
                        ...
                        <div class="inputBox">
                            <input type="submit" name="live" value="Add helps" required>
