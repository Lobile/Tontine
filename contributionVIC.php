...
if (isset($_GET['case'])) {
    ...
    if ($id >= $today) {
        ...
        header("location:contributionVIC.php");
    }
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="index-2.html" class="logo-text"><span>Ndjangi</span></a>
                    </div><!-- Logo Box -->
...
?>
            ...
            while ($row = $result2->fetch_assoc()):
                ?>
                        ...
                        echo"<b>Beneficiary of Contribution 2000 is:</b><b>".$row['firstname']; $row['lastname']."</b>"; 
                        endwhile;
                        while($row=$result43->fetch_assoc()):
                            echo"<b>Beneficiary of Contribution 5000 is:</b><b>".$row['firstname']; $row['lastname']."</b>"; 
                      endwhile;
