...
<body>
    ...
    $result2 = $mysqli->query("SELECT member_id, contribution_id, lastname, firstname FROM Member inner join Contribution on member_id = contribution_id  where contribution = 5000 ") or die(mysqli_error($mysqli));
    $result = $mysqli->query("SELECT member_id, contribution_id, lastname, firstname FROM Member inner join Contribution on member_id = contribution_id  where contribution = 5000 and activepaid=1 ") or die(mysqli_error($mysqli));
    $result5 = $mysqli->query("SELECT member_id,benefiter_id,  lastname, firstname FROM Member inner join benefiter on member_id-1 = benefiter_id where benefiter=curdate() ") or die(mysqli_error($mysqli));
    ...
    <center>
        <div class="container">
            ...
            <a href="cotisation.php?page=contributefine5000"  id="soa">Fine_Payment</a>
            <div class="row">
                <table class="table-responsive" id="table" style=" font-family: var(--JosefinSans);">
                    ...
                    ?>
                     ...
                     <td>  
                                <div class="action">
                                    ...
                                    <a href="upload.php?5000=<?php echo $row['contribution_id']; ?>" class="btn btn-success">paid</a>
                                    <a href="upload.php?Not=<?php echo $row['contribution_id']; ?>" class="btn btn-danger">Not_paid</a>
    ...
    <?php
                    ...
                    ?>
                                    <a href="upload.php?benefit2=<?php echo $row['benefiter_id']; ?>" id="soa">benefit</a>
                                    <?php endwhile; ?>
                                    <a href="Recu_5K.php"><button class="btn btn-rounded">Beneficiary_invoice </button></a>  
