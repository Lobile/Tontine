...
$result44 = $mysqli->query("SELECT  firstname, lastname FROM member left join benefiter on member.member_id=benefiter.benefiter_id where contribution = 7000 and benefiter = '$now'") or die(mysqli_error($mysqli));
$result43 = $mysqli->query("SELECT  firstname, lastname FROM member left join benefiter on member.member_id=benefiter.benefiter_id where contribution = 5000 and benefiter='$now'") or die(mysqli_error($mysqli));
$result42 = $mysqli->query("SELECT  firstname, lastname FROM member left join beneficiary on member.member_id=beneficiary.benefit_id where contribution = 2000 and beneficiary='$now'") or die(mysqli_error($mysqli));
...
$next = date('d-m-Y', strtotime($today . ' + 157 days'));
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="indexVICAD.html" class="logo-text"><span>Ndjangi</span></a>
                </div><!-- Logo Box -->
