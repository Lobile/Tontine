...
$result = $mysqli->query("SELECT member_id, contribution_id, lastname, firstname FROM Member right join Contribution on member_id = contribution_id where contribution_payment like 'not_paid2%'  and activefine = 1 ") or die(mysqli_error($mysqli));
$result4 = $mysqli->query("SELECT member_id, contribution_id, sum(contribution_amount)*80/100 as derty, firstname, beneficiary FROM Member left join beneficiary on member_id = benefit_id right join Contribution on contribution_id=member_id where contribution = 2000 and beneficiary = curdate()") or die(mysqli_error($mysqli));
/* pre_r($result); */
?>
...
<center><h2><u>2000 Contribution</u> </h2></center>
<?php
        ...
        <table  class="" style=" font-family: var(--JosefinSans);"  id="table">
            ...
            while ($row = $result->fetch_assoc()):
                ...
                <tr>
                    ...
                    <a href="upload.php?2500=<?php echo $row ['contribution_id']; ?>"   class="btn btn-success">paid_fine</a><br>
                    <a href="upload.php?Not8=<?php echo $row ['contribution_id']; ?>"   class="btn btn-danger">Not_paid</a>
